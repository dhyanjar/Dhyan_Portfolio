...
export function Hero() {
  ...
  return (
    <section ref={container} className="relative pt-[180px] pb-[80px] md:pt-[240px] md:pb-[120px] border-b border-obsidian-border overflow-hidden">
      <div className="hero-content max-w-7xl mx-auto px-[20px] md:px-[64px] relative z-10 flex flex-col items-start justify-center">
        ...
        <div className="w-full relative z-10">
          ...
          <div className="hero-desc mt-10">
            <a href={RESUME_URL} download className="inline-flex items-center justify-center gap-3 bg-obsidian-text text-obsidian-bg px-6 py-4 font-mono text-[10px] md:text-[12px] uppercase tracking-widest hover:bg-obsidian-accent transition-colors group">
