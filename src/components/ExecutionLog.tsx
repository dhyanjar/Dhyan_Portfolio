      ...
      <div className="max-w-7xl mx-auto px-[20px] md:px-[64px]">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 md:mb-16 gap-4">
          ...
          <button 
            ...
            className="flex items-center gap-2 font-mono text-[10px] uppercase tracking-widest text-obsidian-muted hover:text-obsidian-accent transition-colors self-end md:self-auto cursor-pointer group"
          >
            <span>View Full Details</span>
            <ArrowRight className="hidden md:block w-4 h-4 group-hover:translate-x-1 transition-transform" />
          </button>
        </div>
